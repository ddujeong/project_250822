...
<body>
  ...
  <main class="container">
    <h2>총 ${totalBoardCount } 개의 게시글</h2> <span class="post-count"></span>
<!-- 검색 + 글쓰기 버튼 묶기 -->
<div class="top-actions" >
  <form action="boardlist.do" method="get" class="search-bar search-form">
  ...
  <c:if test="${not empty user_id}">
    ...
    <table class="notice-table">
      ...
      <c:forEach var="bDto" items="${bDtos }" >
        <tr>
          <td>${bDto.bno }</td>
          <td><a href="contentview.do?bnum=${bDto.bnum }">${bDto.btitle }</a></td>
